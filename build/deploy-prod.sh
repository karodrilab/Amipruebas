...
sfdx force:mdapi:deploy -c -d packageRoles -u my-hub-orgPruebasCI -w 10 -l RunSpecifiedTests -r AMICAR_ChecklistGetJSONTest -w 33 --outputdir test-results --resultformat --verbose --loglevel fatal 
